...
public class PlayFrame extends JFrame {
    ...
    class card_panel extends JPanel {
        public card_panel() {
            setLayout(null);
            ImageIcon drawCardImg = new ImageIcon("GameInterface/drawCard.png");
            drawCard = new JButton(drawCardImg);
            ImageIcon selectDrawCard = new ImageIcon("GameInterface/selectDrawCard.png");
            drawCard.setRolloverIcon(selectDrawCard);
            ImageIcon pressDrawCard = new ImageIcon("GameInterface/pressDrawCard.png");
            ...
            ImageIcon backImg = new ImageIcon("GameInterface/backImg.png");
            JButton backButton = new JButton(backImg);
            ImageIcon selectBack = new ImageIcon("GameInterface/backselect.png");
            ...
            backButton.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    int opt = JOptionPane.showConfirmDialog(null, "Do you want to end this game?", "waring",
            ...
            ImageIcon ruleImg = new ImageIcon("GameInterface/rule.png");
            ...
            ImageIcon selectRule = new ImageIcon("GameInterface/ruleselect.png");
            ruleButton.setRolloverIcon(selectRule);
            ImageIcon rulePressImg = new ImageIcon("GameInterface/rulePress.png");
            ...
            ImageIcon goldIcon = new ImageIcon("GameInterface/littleGold.png");
        ...
        public void paintComponent(Graphics g) {
            ...
            if (thread.getGameFlow().getClockwise()) {
                Image bg = new ImageIcon("GameInterface/bg1.png").getImage();
                g.drawImage(bg, 0, 0, null);
            } else {
                Image bg = new ImageIcon("GameInterface/bg2.png").getImage();
                g.drawImage(bg, 0, 0, null);
            }
            // player
            for (int i = 0; i < 4; i++) {
                ...
                if (i + 1 == thread.getnowPlayer() && thread.getGameFlow().getPlayer(i + 1).getAlive()) {
                    Image image = new ImageIcon("GameInterface/now" + (i + 1) + ".png").getImage();
                    g.drawImage(image, 180 + 309 * i, 40, 200, 200, null);
                } else if (thread.getGameFlow().getPlayer(i + 1).getAlive()) {
                    Image image = new ImageIcon("GameInterface/wait" + (i + 1) + ".png").getImage();
                    g.drawImage(image, 180 + 309 * i, 40, 200, 200, null);
                } else {
                    Image image = new ImageIcon("GameInterface/player2.png").getImage();
                    g.drawImage(image, 180 + 309 * i, 40, 200, 200, null);
                }
            }
